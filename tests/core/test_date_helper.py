...
CHICAGO_SPRING_FORWARD_BEFORE = datetime.datetime.fromisoformat("2026-03-08T01:59:59").replace(
    tzinfo=CHICAGO_TZ
)  # CST = UTC-6
CHICAGO_SPRING_FORWARD_AFTER = datetime.datetime.fromisoformat("2026-03-08T03:00:01").replace(
    tzinfo=CHICAGO_TZ
)  # CDT = UTC-5
# DST fall back: Sunday Nov 1 2026, clocks fall 2am → 1am
CHICAGO_FALL_BACK_BEFORE = datetime.datetime.fromisoformat("2026-11-01T01:59:59").replace(
    tzinfo=CHICAGO_TZ, fold=0
)  # CDT = UTC-5
CHICAGO_FALL_BACK_AFTER = datetime.datetime.fromisoformat("2026-11-01T01:59:59").replace(
    tzinfo=CHICAGO_TZ, fold=1
)  # CST = UTC-6
